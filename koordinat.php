...
<html lang="en">
  ...
  <body>
    ...
    <div class="hero-wrap js-fullheight" style="background: url('images/tugu3.jpg') no-repeat center center fixed;background-size: cover ;" data-stellar-background-ratio="0.5">
      ...
      <img src="images/logooo.png" align="center"><HR style="color:white;">
      <h6 style="color: white;" align="center" >SIKAHKAN TANDAI LOKASI ANDA</h6><HR>
...
function initialize() {
  var propertiPeta = {
    center:new google.maps.LatLng(-7.78381252262822, 110.35741738201025),
    zoom:13,
